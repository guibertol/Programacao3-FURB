(function ($) {
    ...
    var CarrinhoController = function () {
        ...
        $.extend(self, {
            ...
            isValidAdesivagem: function (produto_index) {
                ...
                if(typeof carrinho.itens[produto_index]['B1_ZTIPO'] == "undefined"){
            ...
            /** 
                Nota mental escrita por guilherme bertol
                A variavel codtab que vem do parametro é uma constante em app/Preco.php, ela é transformada
                de variavel PHP para Javascript na view
            ...
            */
            getItemPreco: function (produto_index, codtab) {
                ...
                codtab_bk = codtab;
                 ...
                 if(codtab == "350" || codtab == "005" || codtab == "4001" || codtab == "4002" || codtab == "4003" || codtab == "4004" || codtab == "4005" || codtab == "4006" || codtab == '149'){
                    var preco = array_find_item(carrinho.itens[produto_index]['precos'], '001', 'DA1_CODTAB');  
                }else{
                    var preco = array_find_item(carrinho.itens[produto_index]['precos'], codtab, 'DA1_CODTAB');
                }
                
                if(codtab_bk == '005' && preco['PASSOU'] == undefined){
                
                    var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.072;
                    var verificador = preco['DA1_PRCVEN'].split('.');

                    if(verificador.length==2 && preco['PASSOU'] == undefined){

                        preco['DA1_PRCVEN'] = valor1;
                        preco['DA1_PRCVEN'] = Math.ceil(preco['DA1_PRCVEN']);
                        preco['PASSOU'] = true;

                    }
               
                }else if(preco['PASSOU'] == undefined && (codtab_bk == "4001" || codtab_bk == "4002" || codtab_bk == "4003" || codtab_bk == "4004" || codtab_bk == "4005" || codtab_bk == "4006" || codtab_bk == '149')){

                    if(codtab == "4001"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']);
                    }else if(codtab == "4002"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.018;
                    }else if(codtab == "4003"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.027;
                    }else if(codtab == "4004"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.036;
                    }else if(codtab == "4005"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.045;
                    }else if(codtab == "4006"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.054;
                    }else if(codtab == "149"){
                        var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.072;
                    }
                ...
                }else if(codtab_bk == '350' && preco['PASSOU'] == undefined){
										
                    var valor1 = parseFloat(preco['DA1_PRCVEN']) + parseFloat(preco['DA1_PRCVEN'])*0.06125;
                    ...
                    if(verificador == undefined || (verificador.length==2 && preco['PASSOU'] == undefined)){
            ...
            updateItemValues: function (produto_index) {
                ...
                switch (cond_pag_valor) {
                    case '001':
                        ...
                        break;
					case '005':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, "005");
                        break;
                    case '350':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, "350");
                        break;
					case '4001':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4001');
                        break;
                    case '4002':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4002');
                        break;
                    case '4003':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4003');
                        break;
                    case '4004':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4004');
                        break;
                    case '4005':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4005');
                        break;
                    case '4006':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '4006');
                        break;
                    case '149':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, '149');
                        break;
                    case '002':
                    ...
                    case '168':
                        ...
                        break;
                    case '019':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_30_60);
                        break;
                    case '020':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_30_60_90_120);
                        break;
                    case '029':
                        preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_CARTAO);
                        break;
                ...
                if(carrinho.itens[produto_index].tipo_id == "1"){
                    carrinho.itens[produto_index].B1_ZTIPO = "1";
                }
                ...
                if (adicional > 0){
                    ...
                    if((condicao_venda == '2' || condicao_venda == '4' || condicao_venda == '5' || condicao_venda == '6' || condicao_venda == '7' || condicao_venda == '40') && carrinhoView.getValueTabelaVenda() != '') {
    ...
    var FiltroController = function () {
        ...
        $.extend(self, {
            setAcessorios: function (item) {
                f_acessorios.push(item);
            },
            ...
            filtroAcessorio: function (acessorio_id) {
                ...
                if (f_acessorios.length){
                    ...
                    $.each(f_acessorios, function (index, item) {
                        ...
                        if (item['id'].indexOf(acessorio_id) != -1){
...
(function ($, carrinhoController) {
   // var Continua = true; 
        ...
        $.extend(self, {
            ...
            init: function () {
                ...
                $input_condicao_pagamento.change(function () {
                    if (this.value == '001' || this.value == '021' || this.value == '071' || this.value == '081' || this.value == '095' || this.value == '163')
            ...
            setCondicaoPagamento: function (tipo) {                
                ...
                * */ 
                ...
                if (tipo == condicaoPagamentoView.CONDICAO_PAGAMENTO_AVISTA){ //A VISTA
                    ...
                    //PROMOCIONAL A VISTA
                    if (condicao_pagamento_valor == '071' || condicao_pagamento_valor == '081' || condicao_pagamento_valor == '095'  || condicao_pagamento_valor == '163'){
                    ...
                    //PROMOCIONAL 150     
                    ...
                    } else if(condicao_pagamento_valor === '149'){
                        
                        total = carrinho.total;

                        let dt_atual = moment(hoje); 
                        dias_hoje = dt_atual.format('DD/MM/YYYY');
                        dias_30 = dt_atual.add(30, 'days'); dias_30_format = dias_30.format('DD/MM/YYYY');
                        dias_60 = dt_atual.add(30, 'days'); dias_60_format = dias_60.format('DD/MM/YYYY');
                        dias_90 = dt_atual.add(30, 'days'); dias_90_format = dias_90.format('DD/MM/YYYY');
                        dias_120 = dt_atual.add(30, 'days'); dias_120_format = dias_120.format('DD/MM/YYYY');
                        dias_150 = dt_atual.add(30, 'days'); dias_150_format = dias_150.format('DD/MM/YYYY');
                        dias_180 = dt_atual.add(30, 'days'); dias_180_format = dias_180.format('DD/MM/YYYY');
                        dias_210 = dt_atual.add(30, 'days'); dias_210_format = dias_210.format('DD/MM/YYYY');
                        dias_240 = dt_atual.add(30, 'days'); dias_240_format = dias_240.format('DD/MM/YYYY');
                        dias_270 = dt_atual.add(30, 'days'); dias_270_format = dias_270.format('DD/MM/YYYY');

                        let entrada_1 = total*0.10;   

                        parcelas = utils.calc_parcelas(total-entrada_1, 10);

                        components.tabela.parcelas.p1.valor.appSetMoney(entrada_1);
                        formaPagamentoView.addTotalSoma(entrada_1);
                        components.tabela.parcelas.p1.condicao[0].selectize.setValue(FORMA_AVISTA);
                        components.tabela.parcelas.p1.data.val(dias_hoje);
                        
                        components.tabela.parcelas.p2.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p2.condicao[0].selectize.setValue(FORMA_AVISTA);
                        components.tabela.parcelas.p2.data.val(dias_30_format);

                        components.tabela.parcelas.p3.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p3.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p3.data.val(dias_60_format);

                        components.tabela.parcelas.p4.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p4.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p4.data.val(dias_90_format);

                        components.tabela.parcelas.p5.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p5.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p5.data.val(dias_120_format);

                        components.tabela.parcelas.p6.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p6.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p6.data.val(dias_150_format);

                        components.tabela.parcelas.p7.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p7.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p7.data.val(dias_180_format);

                        components.tabela.parcelas.p8.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p8.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p8.data.val(dias_210_format);
                        ...
                        components.tabela.parcelas.p9.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p9.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p9.data.val(dias_240_format);

                        components.tabela.parcelas.p10.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p10.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p10.data.val(dias_270_format);

                    }else if(condicao_pagamento_valor == '019'){
                    ...
                    }else if(condicao_pagamento_valor == '020'){

                        total = carrinho.total;

                        let dt_atual = moment(hoje); 
                        dias_10 = dt_atual.add(10, 'days'); dias_10_format = dias_10.format('DD/MM/YYYY'); 
                        dias_30 = dt_atual.add(30, 'days'); dias_30_format = dias_30.format('DD/MM/YYYY');
                        dias_60 = dias_30.add(30, 'days'); dias_60_format = dias_60.format('DD/MM/YYYY');
                        dias_90 = dias_60.add(30, 'days'); dias_90_format = dias_90.format('DD/MM/YYYY');
                        dias_120 = dias_90.add(30, 'days'); dias_120_format = dias_120.format('DD/MM/YYYY');
                        ...
                        let entrada_1 = null;                       
                        entrada = round(total * 0.1);
                        resto = round(total - entrada - entrada);
                        ...
                        formaPagamentoView.addTotalSoma(entrada);
                        components.tabela.parcelas.p2.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p2.data.val(dias_10_format);                            
                    ...
                    }else if(condicao_pagamento_valor == '029'){
                        ...
                        parcelas = utils.calc_parcelas(total, 4);
                        
                        components.tabela.parcelas.p1.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p1.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p1.data.val(dias_30_format);
                    ...
                    }else if(condicao_pagamento_valor == '005'){
                        ...
                        dias_210 = dias_180.add(30, 'days'); dias_210_format = dias_210.format('DD/MM/YYYY');
                        dias_240 = dias_210.add(30, 'days'); dias_240_format = dias_240.format('DD/MM/YYYY');
                        dias_270 = dias_240.add(30, 'days'); dias_270_format = dias_270.format('DD/MM/YYYY');
                        
                        let entrada_1 = total*0.10;    
                        let saida = total*0.10;      

                        parcelas = utils.calc_parcelas(total-entrada_1-saida, 8);
                        ...
                        components.tabela.parcelas.p2.valor.appSetMoney(saida);
                        formaPagamentoView.addTotalSoma(saida);
                        components.tabela.parcelas.p2.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p2.data.val(dias_30_format);
                    ...
                    }else if(condicao_pagamento_valor == '4001'){



                    }else if(condicao_pagamento_valor == '4002'){
                        ...
                        parcelas = utils.calc_parcelas(total-entrada_1, 1);
                    ...
                    }else if(condicao_pagamento_valor == '4003'){
                        ...
                        parcelas = utils.calc_parcelas(total-entrada_1, 2);
                    ...
                    }else if(condicao_pagamento_valor == '4004'){
                        ...
                        parcelas = utils.calc_parcelas(total-entrada_1, 3);
                    ...
                    }else if(condicao_pagamento_valor == '4005'){
                        ...
                        parcelas = utils.calc_parcelas(total-entrada_1, 4);
                    ...
                    }else if(condicao_pagamento_valor == '4006'){
                        ...
                        parcelas = utils.calc_parcelas(total-entrada_1, 5);
                    ...
                    }else if(condicao_pagamento_valor == '350'){

                        total = carrinho.total;

                        let dt_atual = moment(hoje); 
                        dias_hoje = dt_atual.format('DD/MM/YYYY');
                        entrada2 = moment('2019-12-15'); dias_entrada2_format = entrada2.format('DD/MM/YYYY');
                        entrada3 = entrada2.add(30, 'days'); dias_entrada3_format = entrada3.format('DD/MM/YYYY');

                        dias_30 = entrada3.add(30, 'days'); dias_30_format = dias_30.format('DD/MM/YYYY');
                        dias_60 = dias_30.add(30, 'days'); dias_60_format = dias_60.format('DD/MM/YYYY');
                        dias_90 = dias_60.add(30, 'days'); dias_90_format = dias_90.format('DD/MM/YYYY');
                        dias_120 = dias_90.add(30, 'days'); dias_120_format = dias_120.format('DD/MM/YYYY');
                        dias_150 = dias_120.add(30, 'days'); dias_150_format = dias_150.format('DD/MM/YYYY');
                        ...
                        let entrada_1 = total*0.10;   
                        let entrada_2 = total*0.10;   

                        parcelas = utils.calc_parcelas(total-entrada_1-entrada_2-entrada_2, 6);
                        ...
                        formaPagamentoView.addTotalSoma(entrada_2);
                        components.tabela.parcelas.p2.condicao[0].selectize.setValue(FORMA_AVISTA);
                        components.tabela.parcelas.p2.data.val(dias_entrada2_format);

                        components.tabela.parcelas.p3.valor.appSetMoney(entrada_2);
                        formaPagamentoView.addTotalSoma(entrada_2);
                        components.tabela.parcelas.p3.condicao[0].selectize.setValue(FORMA_AVISTA);
                        components.tabela.parcelas.p3.data.val(dias_entrada3_format);
                        ...
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p7.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p7.data.val(dias_120_format);

                        components.tabela.parcelas.p8.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p8.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p8.data.val(dias_150_format);

                        components.tabela.parcelas.p9.valor.appSetMoney(parcelas);
                        formaPagamentoView.addTotalSoma(parcelas);
                        components.tabela.parcelas.p9.condicao[0].selectize.setValue(FORMA_PRAZO);
                        components.tabela.parcelas.p9.data.val(dias_180_format);
    ...
    var ClienteView = function () {
        ...
        var render_cliente_telefone1 = $container.find('#cliente-telefone1');
        var render_cliente_telefone2 = $container.find('#cliente-telefone2');
        ...
        $.extend(self, {
            ...
            update: function (data) {
                ...
                render_cliente_telefone1.text(data.A1_TEL);
                render_cliente_telefone2.text(data.A1_TELEX);
    ...
    var CarrinhoView = function () {
        ...
        $.extend(self, {
            ...
            updatePreco: function (produto) {
                ...
                carrinhoController.getItemPrecos({
                    ...
                    if (status == 1) {
                        ...
                        str = JSON.stringify(produto_detalhes);

                        if(produto_detalhes['tipo_id'] == "1"){
                            produto_detalhes['B1_ZTIPO'] = "1";
                        }
            ...
            add: function (produto) {
                ...
                if(cond_pag_valor === '001'){
                ...
                }else if(cond_pag_valor == '005'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '005');
                
                }else if(cond_pag_valor == '350'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '350');
                
                }else if(cond_pag_valor === '4001'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4001');
                
                }else if(cond_pag_valor === '4002'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4002');
                
                }else if(cond_pag_valor === '4003'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4003');
                
                }else if(cond_pag_valor === '4004'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4004');
                }else if(cond_pag_valor === '4005'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4005');               
                }else if(cond_pag_valor === '4006'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '4006');
                }else if(cond_pag_valor === '149'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, '149');
                    ...
                    preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_PROMO_5_PECAS_30_60_90_120_150);
                }else if(cond_pag_valor === '019'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_30_60);
                }else if(cond_pag_valor === '020'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_30_60_90_120);
                }else if(cond_pag_valor === '029'){
                    preco_unitario = carrinhoController.getItemPreco(produto_index, CODTAB.CODTAB_RDC_CARTAO);
                }
                ...
                if (adicional > 0){
                    ...
                    if(opc_venda == '1' || opc_venda == '3') { //Promocional,Black Friday
                        ...
                        $render_subtotal.text(Format.preco(carrinho_item.subtotal));
                    ...
                    } else if(opc_venda == '5' || opc_venda == '2' || opc_venda == '4' || opc_venda == '39' || opc_venda == '40') {
                            ...
                            carrinho_item.subtotal = (preco_unitario_desc * quantidade) + carrinho_item.st_valor + carrinho_item.ipi_valor;
                            carrinho_item.subtotal_bruto_desconto = preco_unitario_desc *quantidade;
                    ...
                    }else if(opc_venda == '6' || opc_venda == '7'){
                        ...
                        var dados = {
                            id_cliente : $('#select-clientes').val()
                        }

                        var ret = $.ajax({
                            url: base_url + '/api/vendedor/possui_promocao/' + dados.id_cliente,
                            data: dados,
                            type: 'GET',
                            async: false,
                            success: function (data) {
                                
                                var qtd_carrinho = carrinhoView.getProdutoCount();

                                if(data.promocao){
                                    if(data.sucesso && ( qtd_carrinho>=data.quantidade_minima)){
                                        return true;
                                    }else{
                                        return false;
                                    }
                        ...
                        if(!ret.responseJSON[0].intervalo_promocao || !ret.responseJSON[0].sucesso){
                            swal('Atenção!', ret.responseJSON[0].mensagem, 'warning');
                            return false;
                        }
            ...
            show: function () {
                ...
                if(quantidade_select_tabela_venda == 8){

                    if(valor_tabela_comissao == 1){
                        texto = '7%';
                    }else if(valor_tabela_comissao == 2){
                        texto = '6%';
                    }else if(valor_tabela_comissao == 3){
                        texto = '5,50%';
                    }else if(valor_tabela_comissao == 4){
                        texto = '5%';
                    }else if(valor_tabela_comissao == 5){
                        texto = '4,50%';
                    }else if(valor_tabela_comissao == 6){
                        texto = '4,00%';
                    }else if(valor_tabela_comissao == 7){
                        texto = '4,50%';
                    }else if(valor_tabela_comissao == 8){
                        texto = '3%';
                    }
                    ...
                    if(valor_tabela_comissao == 1){
                        ...
                        texto = '4%';
                    }else if(valor_tabela_comissao == 9){
                        texto = '3,50%';
                    }else if(valor_tabela_comissao == 10){
                        texto = '3%';
                    }
            ...
            update: function (produto_index, tr) {
                ...
                var tabela1 = condicaoPagamentoView.getCondicaoPagamentoValue();
                var carrinho_item = carrinhoController.getItem(produto_index);
                var preco_unitario_desc = carrinho_item.preco_unitario_desc;
                var quantidade = parseInt(carrinho_item.quantidade);

               if(tabela1 != '350' || tabela1 != '005' || tabela1 != '4001' || tabela1 != '4002' || tabela1 != '4003' || tabela1 != '4004' || tabela1 != '4005' || tabela1 != '4006' || tabela1 != '149'){
                    ...
                    var calculo_valor_soma_quantidade = preco_unitario_desc*quantidade;
                    carrinho_item.subtotal = calculo_valor_soma_quantidade + carrinho_item.st_valor + carrinho_item.ipi_valor;
                    ...
                    tr.find('[data-target="subtotal_bruto"]').text(Format.preco(calculo_valor_soma_quantidade));
                    tr.find('[data-target="subtotal_bruto_desconto"]').text(Format.preco(calculo_valor_soma_quantidade));
    ...
    var FiltroView = function () {
        ...
        //PROMOÇÃO
        var $dv_representante_riberfoods = $('#dv-representante-riberfoods');
        var $dv_cond_promo_5 = $('#dv-cond-promo-5');
        var $dv_cond_promo_6 = $('#dv-cond-promo-6');
        var $dv_cond_promo_7 = $('#dv-cond-promo-7');
        var $dv_cond_normal39 = $('#dv-cond-normal39');
		var $dv_cond_normal40 = $('#dv-cond-normal40');
        ...
        $dv_finalidade_venda.change(function() {
            if(select_finalidade_venda.val() == "D"){
                $('#promo_15_dias').removeClass('hidden');
                $('#promo_normal_normal').addClass('hidden');
            }else{
                $('#promo_15_dias').addClass('hidden');
                $('#promo_normal_normal').removeClass('hidden');
            }
        });
        ...
        $.extend(self, {
            setTiposProdutos: function () {
                ...
                selectize_produtos_tipos.load(function(callback) {
                    ...
                    if(filtroView.getOpcVenda() === '3' || filtroView.getOpcVenda() === '4') {
                        ...
                        if(select_finalidade_venda.val() == 'N' || select_finalidade_venda.val() == 'F') {
                            produtos_tipos.splice(4, 1);
                        }
                        callback(produtos_tipos);
                    }                    
                });
            ...
            setCondicaoVenda1: function () {
               ...
               // selectize_condicao_venda.clearOptions();
                ...
                opc_venda.push(
                    {'id': '2', 'nome': 'Normal'},
                    {'id': '5', 'nome': 'Campanha Inverno 2020'}/*, 
            ...
            init: function () {
                ...
                select_produtos_voltagem.selectize({
                    ...
                    onChange: function (voltagem_id) {
                        ...
                        if(tabela == '021'){
                            ...
                            tabela = '004';
                        }else if(tabela == '350' || tabela == '005' || tabela == '4001' || tabela == '4002' || tabela == '4003' || tabela == '4004' || tabela == '4005' || tabela == '4006' || tabela == '149'){
                            tabela = '001';
                        }
                        ...
                        if(results != undefined){
                            for(let i = 0; i < results.length; i++) {
                                ...
                                $.ajax({
                                    ...
                                    if(i==results.length-1 && contador==0){
                                        //enviar_email_preco(result, tabela, tp_oper);
                                        //swal("Ops!", "Não encontramos um preço para esse produto, por favor entre encontado com o suporte", 'error');
                                    }
                ...
                $( "#acessorioSelect" ).change(function() {

                    var tipo = select_produtos_tipos[0].selectedOptions[0].value;
                    ...
                    if(tipo != "1"){
                        ...
                        try {
                           var r = filtroController.filtroAcessorio("1");
                        ...
                        if (values) {
                            ...
                            if (i >= 0) {
                                ...
                                $('#acessorioSelect').find('option').each(function() {
                                    var valor = $(this).val();
                                    if(valor != "1"){
                                        $("#acessorioSelect option[value='"+valor+"']").remove();
                                    }  
                                });
                                
                            }else{
                                $("#acessorioSelect option[value='1']").remove();
                            }
                        }
                        
                        $.ajax({
                            url: base_url + '/vendedor/produto/acessorios_disponiveis',
                            data: {'array' : $('#acessorioSelect').val()},
                            type: 'POST',
                            async: false,
                            success: function (data) {

                                var data_origem = data;
                                var r = filtroController.filtroAcessorio(data);
                                ...
                                var tipo = select_produtos_tipos[0].selectedOptions[0].value;
                                var modelo = select_produtos_modelos[0].selectedOptions[0].value;
                                var cor = select_produtos_cores[0].selectedOptions[0].value;
                                var cond_pag_valor = condicaoPagamentoView.getCondicaoPagamentoValue();  
                                ...
                                var data = {
                                    ...
                                    tipo: tipo,
                                    cor : cor,
                                    tabela: cond_pag_valor
                                }

                                $.ajax({
                                    url: base_url + '/vendedor/sem_produto',
                                    type: 'POST',
                                    data: data,
                                    async: false,
                                    complete: function(result){
                                        
                                        var congelador_resposta = result.responseJSON.data;

                                        for(i=0; i<congelador_resposta.length; i++){

                                            var congelador = congelador_resposta[i];

                                            var retorno = {
                                                acessorio_id: congelador.B1_ZACESSO,
                                                nome: "127V",
                                                produto_id: ""+congelador.B1_COD,
                                                produto_nome: congelador.B1_DESC,
                                                id: ""+congelador.B1_TENSAO,
                                                B1_COD: ""+congelador.B1_COD,
                                                B1_IPI: parseFloat(congelador.B1_IPI),
                                                B1_DESC: congelador.B1_DESC,
                                                B1_ZMODELO: congelador.B1_ZMODELO,
                                                B1_ZACESSO: congelador.B1_ZACESSO,
                                                B1_TENSAO: congelador.B1_TENSAO,
                                                B1_ZTIPO: congelador.B1_ZTIPO,
                                                B1_COR: congelador.B1_COR
                                            }

                                            var prod1 = {
                                                id: congelador.B1_ZACESSO,
                                                nome: 'a',
                                                produto_id: ""+congelador.B1_COD,
                                                produto_nome: congelador.B1_DESC,
                                                voltagem_id: ""+congelador.B1_TENSAO,
                                                B1_COD: ""+congelador.B1_COD,
                                                B1_IPI: parseFloat(congelador.B1_IPI),
                                                B1_DESC: congelador.B1_DESC,
                                                B1_ZMODELO: congelador.B1_ZMODELO,
                                            ...
                                            filtroController.addProduto(retorno);
                                            filtroController.setAcessorios(prod1);
                                ...
                                var r2 = filtroController.filtroAcessorio(data_origem);
                                selectize_produtos_voltagem.$wrapper.removeClass('hidden');
                                selectize_produtos_voltagem.$dropdown.removeClass('hidden');
                ...
                select_produtos_cores.selectize({
                    ...
                    onChange: function (cor_id) {
                        ...
                        console.log('r cores'+r);


                        
                        if (r != null){
                            $('#acessorioSelect').prop('disabled', false);
                        }else{
                            ...
                            if(tipo == "7"){
                                ...
                                selectize_produtos.load(function (callback) {
                                    ...
                                    var r = [];
                                    if(modelo == "3"){
                                        r.push({'id': '64020489', 'nome': 'GRADE PRATELEIRA P/ FRANGOS - CONGELADOR SC 224  '});
                                    }else if(modelo == "4"){
                                        r.push({'id': '64020490', 'nome': 'GRADE PRATELEIRA P/ FRANGOS - CONGELADOR SC 324  '});
                                    }else if(modelo == "5"){
                                        r.push({'id': '64020491', 'nome': 'GRADE PRATELEIRA P/ FRANGOS - CONGELADOR SC 424  '});
                                    } 
                                    callback(r);
                ...
                select_produtos_tipos.selectize({
                    ...
                    onChange: function (tipo_id) {
						...
						if(tipo_id != "1"){
							$("#acessorioSelect").html('<option value="1">Sem acessorio</otpion>');
						}
                ...
                select_condicao_venda.selectize({
                    ...
                    onChange: function (opc_venda) {
                        ...
                        if (opc_venda == '1'){ //Condição de Venda Promocional
                            ...
                            $dv_representante_riberfoods.addClass('hidden');
                            $dv_cond_normal39.addClass('hidden');
							$dv_cond_normal40.addClass('hidden');
                            $dv_cond_promo_5.addClass('hidden');
                            $dv_cond_promo_6.addClass('hidden');
                            $dv_cond_promo_7.addClass('hidden');
                            $dv_cond_normal.removeClass('hidden');

                            //TODO regra para 45 dias sorveteiro e 20 revendedor
                            //if(select_finalidade_venda.val() === 'R'){
                        ...
                        } else if(opc_venda == '39') { 

                            $dv_cond_normal39.removeClass('hidden');
                            $dv_cond_normal.addClass('hidden');
                            $dv_cond_promo_5.addClass('hidden');
                            $dv_cond_promo_6.addClass('hidden');
                            $dv_cond_promo_7.addClass('hidden');
                        ...
                        }else if(opc_venda == '40'){ 

                            $dv_cond_normal40.removeClass('hidden');
                            $dv_cond_normal39.addClass('hidden');
                            $dv_cond_normal.addClass('hidden');
                            $dv_cond_promo_5.addClass('hidden');
                            $dv_cond_promo_6.addClass('hidden');
                            $dv_cond_promo_7.addClass('hidden');
                            $dv_representante_riberfoods.removeClass('hidden');
                ...
                select_tabela_venda.selectize({
                    ...
                    load: function (query, callback) {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                quantidade_select_tabela_venda = res.length;
                                callback(res);

                                if(quantidade_select_tabela_venda == 0){
                                    swal('Atenção', 'Você não possui uma tabela de preço cadastrada, por favor, entre em contato com a artico', 'warning');
                                }
                    ...
                    onChange: function () {
                        ...
                        let opc_venda = filtroView.getOpcVenda();
                ...
                selectize_tabela_venda = select_tabela_venda[0].selectize;
                            ...
                            if(opc_finalidade == 'R'){
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        ...
                                        selectize_tabela_venda.clearOptions();
                                        selectize_tabela_venda.load(function (callback) {
                                            callback(res);
                                        });
                                ...
                                opc_venda = [];
                                opc_venda.push(
                                    {'id': '1', 'nome': 'Tab. 1 (0% + 0%)', 'desc1': '0.0', 'desc2': '0.0'}, 
                                    {'id': '2', 'nome': 'Tab. 2 (0% + 5%)', 'desc1': '0.0', 'desc2': '5.0'}, 
                                    {'id': '3', 'nome': 'Tab. 3 (5% + 5%)', 'desc1': '5.0', 'desc2': '5.0'},
									{'id': '4', 'nome': 'Tab. 4 (0% + 8%)', 'desc1': '0.0', 'desc2': '8.0'}
                                );
            ...
            btnAdd: function () {
                ...
                if(valor_tab_venda == ''){
                    swal('Atenção!', 'Por favor, selecione uma tabela de preço', 'warning');
                    return;
                }
                ...
                var acessorio = $('#acessorioSelect').val();
                ...
                limpar_select2();
                //select_produtos_voltagem.clearOptions();
                $('#acessorioSelect').prop('disabled', true);
                selectize_produtos_voltagem.$wrapper.removeClass('hidden');
                selectize_produtos_voltagem.$dropdown.removeClass('hidden');
            }
...
//                                    }
                    ...
                    .on('success.form.fv', function (e) {
                        if (carrinhoView.getProdutoCount() < 1) {
                            ...
                            if(opc_venda == '1'){
                                ...
                                if($('#select-finalidade-venda').val() != 'D'){
                                    if((valor_tab_venda == 3 || valor_tab_venda == 4) && qtde < 10) {
                                        swal('Atenção', 'A quantidade mínima deve ser de 10 peças, conforme a tabela de Descontos!', 'warning');
                                        $('#check_confirmo').prop('checked', false);
                                        return false;
                                    } else if((valor_tab_venda == 5 || valor_tab_venda == 6) && qtde < 20) {
                                        swal('Atenção', 'A quantidade mínima deve ser de 20 peças, conforme a tabela de Descontos!', 'warning');
                                        $('#check_confirmo').prop('checked', false);
                                        return false;
                                    } else if((valor_tab_venda == 7 || valor_tab_venda == 8 || valor_tab_venda == 9 || valor_tab_venda == 10) && qtde < 80) {
                                        swal('Atenção', 'A quantidade mínima deve ser de 80 peças, conforme a tabela de Descontos!', 'warning');
                                        $('#check_confirmo').prop('checked', false);
                                        return false;
                                    }else if(tabela1 == '005'){
                                        ...
                                        if(tabela1 == '005' && (qtde>40 || qtde<10)){
                                            swal('Atenção!', 'Você deve ter no minimo 10 peças e no maximo 40', 'warning');
                                            return false;
                                        }
                                        ...
                                        if(tabela1 == '350' && (qtde>40 || qtde<10)){
                                            swal('Atenção!', 'Você deve ter no minimo 10 peças e no maximo 40', 'warning');
                                            return false;
                                        }
                                ...
                                if(qtde < ret.responseJSON[0].quantidade_minima){
                                    swal('Atenção!', 'Você deve ter no minimo '+ret.responseJSON[0].quantidade_minima+' peças para aplicar a promoção', 'warning');
                                    return false;
                                }
                                ...
                                if(qtde < ret.responseJSON[0].quantidade_minima){
                                    swal('Atenção!', 'Você deve ter no minimo '+ret.responseJSON[0].quantidade_minima+' itens para aplicar a promoção', 'warning');
                                    return false;
                                }
                                ...
                                if(qtde < 5){
                                    swal('Atenção!', 'Você deve ter no minimo 5 itens para aplicar a promoção', 'warning');
                                    return false;
                                }
                                ...
                                var tabela1 = condicaoPagamentoView.getCondicaoPagamentoValue();
                                 ...
                                 if(tabela1 == '020' && qtde<=5){
                                     swal('Atenção!', 'Você deve ter mais de 5 itens para usar essa tabela', 'warning');
                                     return false;
                                 }
                               ...
                               var tabela1 = condicaoPagamentoView.getCondicaoPagamentoValue();
                                ...
                                if(qtde<=1){
                                    swal('Atenção!', 'Você deve ter no minimo 2 itens para usar essa tabela', 'warning');
                                    return false;
                                }

                            }   

                            var valor = carrinhoController.getItens();
                            var continua = true;
                            $.each(carrinhoController.getItens(), function (index, item) {
                                if(item.desconto2 > 0.08){
                                    continua = false;
                                }
                            });
                            ...
                            if(!continua){
                                ...
                                swal({
                                    title: "Atenção",
                                    text: "Esse pedido excede as regras de desconto, ele entrara como bloqueado",
                                    type: "warning",
                                    showCancelButton: true,
                                    confirmButtonColor: "#ED663E",
                                    ...
                                    function (isConfirm){
                                        if(isConfirm){
                                            document.getElementById('passou_regra').value = 1;
    ...
    var quantidade_select_tabela_venda = 0;
