...
(function ($, carrinhoController) {
   // var Continua = true; 
            ...
            add: function (produto) {
                ...
                if(produto_adesivo == true){
                    ...
                    if(carrinhoView.getValueTabelaVenda() == '') {
                        ...
                        if($('#select-finalidade-venda').val() === 'D') {  //Tipo Distribuidor
                            
                            var template = "<tr>\n    <td>\n        <div data-target=\"id\"></div>\n        <input type=\'hidden\' data-target=\"produto_id\">\n    </td>\n    <td data-target=\"tipo\"></td>\n    <td data-target=\"modelo\"></td>\n    <td data-target=\"cor\"></td>\n    <td>\n        <label>\n            <input class=\"hidden\" type=\"checkbox\" data-target=\"adesivagem\">   \n        </label>\n    </td>\n    <td class=\'wd-td-quantidade td-input\'>\n        <div class=\'form-group\'>\n            <input type=\"text\" class=\"form-control mask-int text-right\" data-target=\'quantidade\' value=\'1\'\n                   autocomplete=\'off\'>\n        </div>\n    </td>\n  <td style=\"width:90px\" class=\"text-right \" data-target=\"preco_unitario\"></td>\n    <!--<td class=\"text-right\" data-target=\"subtotal_bruto\"></td>\n-->       <td class=\'wd-td-quantidade td-input\'>\n     <div class=\'form-group\'>\n        <div class=\"input-group\">\n       <input type=\"text\" data-target=\"adicional\"\n class=\"form-control mask-money text-right\"\n placeholder=\"0\" value=\"0\" autocomplete=\"off\">\n\n   <div class=\"input-group-addon\">%</div>\n  </div>\n   </div>\n   </td>\n         <td class=\'wd-td-quantidade td-input\'>\n        <div class=\'form-group\'>\n       <div class=\"input-group\">\n        <input type=\"text\" data-target=\"desconto1\"\n  class=\"form-control mask-money text-right\"\n   placeholder=\"0\" value=\"0\" autocomplete=\"off\">\n      <div class=\"input-group-addon\">%\n\</div>\n    </div>\n   </div> \n  </td>\n   <td class=\'wd-td-quantidade td-input\'>\n   <div class=\'form-group\'>\n   <div class=\"input-group\">\n    <input type=\"text\" data-target=\"desconto2\"\n  class=\"form-control mask-money text-right\"\n   placeholder=\"0\" value=\"0\" autocomplete=\"off\">\n   <div class=\"input-group-addon\">%</div>\n   </div>\n   </div>\n    </td>\n    <td style=\"width:90px\" class=\"text-right\" data-target=\"preco_unitario_desc\">\n    </td>\n   </div>\n   </div>\n   <!--<input type=\"text\" class=\"form-control text-right\" data-target=\'desconto\' value=\'0\' autocomplete=\'off\'>-->\n    </td>\n    <td style=\"width:90px\" class=\"text-right\" data-target=\"subtotal_bruto_desconto\">\n   </td>\n    <td>\n    <span data-target=\"ipi\" class=\'badge\'></span>\n   <div data-target=\"ipi_valor\" class=\'pull-right\'>\n\</div>\n   </td>\n   <td>\n    <span data-target=\"st\" class=\'badge\'>\n\</span>\n    <div data-target=\"st_valor\" class=\'pull-right\'>\n\</div>\n   </td>\n   <td class=\"text-right\" data-target=\"subtotal\"></td>\n    <td class=\'td-delete\' data-target=\"produto-delete\">x</td>\n   </tr>";
                        } else {
    ...
    var FiltroView = function () {
        ...
        let select_produto = $('#select-produto');
        ...
        var selectize_produto = null/*,
            selectize_produtos = null,
        ...
        $.extend(self, {
            ...
            init: function () {
                ...
                select_condpag.click(function () {
                    ...
                    selectize_produto.$wrapper.removeClass('hidden');
                    selectize_produto.$dropdown.removeClass('hidden');
                ...
                selectize_produto = select_produto[0].selectize;
                ...
                select_condicao_venda.selectize({
                    ...
                    onChange: function (opc_venda) {
                        ...
                        } else { //Condição de Venda Black Friday
            ...
            btnAdd: function () {
                ...
                let codtab = $('[name="condicao_pagamento"]').filter(':checked').val();
                let produto_id = selectize_produto.getValue();
                //let cliente_tpoper = clienteController.get()['TPOPER'];
                let cliente_tpoper = '4';
                //drk

                $.ajax({
                    type: 'get',
                    url: base_url + '/api/produto/precos/' + cliente_tpoper + '/' + produto_id + '/' + codtab,
                    error: function (e) {
                        console.error('error');
                    },
                    success: function (precos) {
