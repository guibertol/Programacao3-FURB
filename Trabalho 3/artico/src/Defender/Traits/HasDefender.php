...
namespace Artico\Defender\Traits;

use Artico\Defender\Permission;
use Artico\Defender\Role;
use Artico\Defender\Traits\Users\HasRoles;
use Artico\Defender\Traits\Users\HasPermissions;
...
trait HasDefender
{
    ...
    {
        $permissions = $this->getAllPermissions($force)->lists(Permission::$COL_NAME)->toArray();
//        dd($permissions);
    ...
    {
        $permissions = $this->getRolesPermissions($force)->lists(Permission::$COL_NAME)->toArray();
    ...
    {
        $roles = $this->roles()->get([Role::$PK])->lists(Role::$PK)->toArray();
     ...
     * @param int $id
     *
     * @return \Artico\Defender\Contracts\User
     */
