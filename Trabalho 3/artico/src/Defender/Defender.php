...
use Artico\Defender\Contracts\Defender as DefenderContract;
...
class Defender implements DefenderContract
{
     ...
     * @param string $roleName
     *
     * @return \Artico\Defender\Role|null
     */
     ...
     * @param string $permissionName
     *
     * @return \Artico\Defender\Permission|null
     */
    ...
    {
        return $this->permissionRepository->getList(Permission::$COL_NAME, Permission::$PK);
    }
    ...
    {
        return $this->roleRepository->getList(Role::$COL_NAME, Role::$PK);
    }
