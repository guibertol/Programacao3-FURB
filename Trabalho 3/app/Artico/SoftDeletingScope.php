...
class SoftDeletingScope implements ScopeInterface
{
     ...
     * @return void
     */
    public function apply(Builder $builder, IlluminateModel $model)
    {
//        $builder->whereNull($model->getQualifiedDeletedAtColumn());
        $builder->where($model->getQualifiedDeletedAtColumn(), $model->getValueNotDeleted());
        $this->extend($builder);
    }
     ...
     * @return void
     */
    public function remove(Builder $builder, IlluminateModel $model)
    {
...
//                'column' => $column,
//                'where' => $where,
//                'soft' => $this->isSoftDeleteConstraint($where, $column)
//            ]);
    ...
    {
//        dd($column);
        return $where['value'] == ' ' && $where['column'] == $column;
    }
